# Cross-Tech AEC Skill Package — LESSONS

## Lessons Learned

_Inherited from Blender, ERPNext, Draw.io, and other skill packages._
...
**Source:** Anthropic Official Guide
**Lesson:** Official skill structure includes scripts/ (executable code) and assets/ (templates, fonts, icons) alongside references/. Consider using these for validation scripts and integration test scripts.
...
**Source:** User feedback, 2026-03-16
**Lesson:** NEVER interpret fundamental questions yourself. ALWAYS explicitly ask the user. Record open questions in OPEN-QUESTIONS.md. This applies to all architecture, scope, approach, and tool choice decisions. Interpretations are ONLY allowed for trivial implementation details.

### L-016: Dependent Package Inventory is Critical for Cross-Tech
**Source:** Cross-Tech AEC project, B0.5, 2026-03-20
**Lesson:** For cross-technology packages, ALWAYS do a dependent package inventory (B0.5) before planning. The availability of dependent packages directly determines which skills can be built and in what order. Skeleton repos ≠ usable packages — check for actual skill content, not just repo existence.
